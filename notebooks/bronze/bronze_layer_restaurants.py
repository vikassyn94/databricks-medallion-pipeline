...
incoming_schema = restaurants_df.schema.json()
...
row_count = restaurants_df.count()
...
mandatory_cols = ("restaurant_id", "restaurant_name", "city", "cuisine", "updated_at")

missing = [c for c in mandatory_cols if c not in restaurants_df.columns]
...
validated_df = (
    ...
    .withColumn(
        ...
        .when(trim(col("restaurant_id")) == "", "EMPTY_RESTAURANT_ID")
