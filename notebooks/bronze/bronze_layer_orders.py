...
incoming_schema = orders_df.schema.json()
...
mandatory_cols = ("order_id", "customer_id", "order_date", "amount", "payment_status", "order_status", "updated_at", "restaurant_id", "partner_id")

missing = [c for c in mandatory_cols if c not in orders_df.columns]
